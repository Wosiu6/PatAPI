...
namespace Infrastructure.Models.HTLB
{
    public class GameData
    {
        ...
        [JsonPropertyName("comp_100_max")]
        public int? Comp100Max { get; set; }

        [JsonPropertyName("comp_100_med")]
        public int? Comp100Med { get; set; }

        [JsonPropertyName("comp_100_min")]
        public int? Comp100Min { get; set; }
        ...
        [JsonPropertyName("comp_speed_h")]
        public int? CompSpeedH { get; set; }

        [JsonPropertyName("comp_speed_l")]
        public int? CompSpeedL { get; set; }
        ...
        [JsonPropertyName("comp_speed100_h")]
        public int? CompSpeed100H { get; set; }

        [JsonPropertyName("comp_speed100_l")]
        public int? CompSpeed100L { get; set; }
